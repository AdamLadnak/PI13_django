...
class Post(models.Model):
    ...
    nadpis = models.CharField(max_length=100, null=True, blank=True)
    kategoria = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, blank=True)
    def __str__(self):
        return f"{self.autor} {self.create_date} {self.publish_date} {self.text} {self.nadpis} {self.kategoria}"
